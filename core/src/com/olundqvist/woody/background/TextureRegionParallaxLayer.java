package com.olundqvist.woody.background;

import com.badlogic.gdx.graphics.g2d.Batch;
import com.badlogic.gdx.graphics.g2d.TextureRegion;
import com.badlogic.gdx.math.Vector2;
import com.olundqvist.woody.util.Enums;
import static com.olundqvist.woody.util.Utils.calculateOtherDimension;
...
public class TextureRegionParallaxLayer extends ParallaxLayer{
	 ...
	 */
	public TextureRegionParallaxLayer(TextureRegion texRegion, float oneDimen, Vector2 parallaxScrollRatio, Enums.WH wh){
		this.texRegion = texRegion;
		switch(wh){
			case WIDTH:
		    	setRegionWidth(oneDimen);
		    	setRegionHeight(calculateOtherDimension(Enums.WH.WIDTH, oneDimen, this.texRegion));
		    	break;
		    case HEIGHT:
		    	setRegionHeight(oneDimen);
		    	setRegionWidth(calculateOtherDimension(Enums.WH.HEIGHT, oneDimen, this.texRegion));
		    	break;
		}
		setParallaxRatio(parallaxScrollRatio);
	}
